...
export default function CheckoutForm(props){
    ...
    return(
        ...
        <div style={{ display: "flex", flexWrap: "wrap", width: "420px"}}>
            ...
            <label>Email
            <input value={formData.email} onChange={handleChange} name="email" required type="email" placeholder="email@email"></input>
            </label>
            <label>Teléfono
            <input value={formData.phone} onChange={handleChange} name="phone" type="tel" placeholder="5411112233"></input>
            </label>
        </div>
